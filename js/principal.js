function inicio(){
    ...
    const navLendo = document.querySelector(".estou-lendo");
    const navQueroLer = document.querySelector(".quero-ler");
    ...
    getMyBooks().then(function(data) {
        ...
        listaItem.innerHTML = ` 
            ...
            if(estante == "currentlyReading"){ 
                $(".estou-lendo").append(listaItem)
            }
            if(estante == "wantToRead"){ 
                $(".quero-ler").append(listaItem)
            } 
            if(estante == "read"){ 
